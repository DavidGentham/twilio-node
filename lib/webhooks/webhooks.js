...
function getExpectedTwilioSignature(authToken, url, params) {
  ...
  console.log('////log twilio data:', data);
...
function validateRequest(authToken, twilioHeader, url, params) {
  ...
  console.log('///twilio header', twilioHeader);
  ...
  console.log('///signature w port: ', signatureWithPort);
  console.log('///signature wOut port: ', signatureWithoutPort);
...
function validateExpressRequest(request, authToken, opts) {
  ...
  if (options.url) {
    console.log('///options url specified: ', options.url);
  ...
  if (webhookUrl.indexOf('bodySHA256') > 0) {
    console.log('///index of sha256, validateRequestWithBody ');
    ...
    console.log('///not index of sha256, validateRequest ');
